    ...
    public class ProductManager : IProductService
    {
        ...
        public async Task<IResult> Delete(Product product)
        {
            IResult result = BusinessRules.Run(
                await CheckIfProductExistsToBaskets(product.Id),
                await CheckIfProductExistsToOrderDetails(product.Id
                ));
            if (result != null)
            {
                return result;
        ...
        public async Task<IResult> CheckIfProductExistsToBaskets(int productId)
        {
        ...
        public async Task<IResult> CheckIfProductExistsToOrderDetails(int productId)
        {
